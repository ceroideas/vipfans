...
@section('title' , 'Vip fans - Editar usuario')
@section('title_content' , 'Editar usuario')
@section('body')
                    ...
                    <form action="{{ url('/admin/users/'.$u->id) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    @php
                                        $d = new DateTime($u->born_date);
                                    @endphp
                                    <label for="born_date">Fecha de nacimiento</label>
                                    <input type="text" name="born_date" id="born_date" class="form-control mydatepicker" placeholder="dd/mm/yyyy" value="{{ $d ? $d->format('d/m/Y') : '' }}">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select name="gender" id="gender" class="form-control">
                                        ...
                                        <option value="2" {{ $u->gender == 2 ? 'selected' : '' }}>Femenino</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select name="city" id="city" class="form-control">
                                        ...
                                        @foreach($c as $ci)
                                            <option value="{{ $ci->id }}" {{ $u->city_id == $ci->id ? 'selected' : '' }}>{{ $ci->estadonombre }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select name="theme" id="theme" class="form-control">
                                        ...
                                        @foreach($t as $te)
                                            <option value="{{ $te->id }}" {{ $u->theme == $te->id ? 'selected' : '' }}>{{ $te->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option value="0" {{ $u->status == 0 ? 'selected' : '' }}>Bloqueado</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-9">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="input-file-now" class="dropify" name="avatar" accept="image/*" data-default-file="{{ $u->avatar ? $u->avatar : '' }}" />
                                </div>  
                            </div>
                        </div>
                        <div class="form-group">
